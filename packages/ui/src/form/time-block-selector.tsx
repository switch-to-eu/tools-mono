...
import { Clock, Zap, X, ChevronDown } from "lucide-react";
    ...
    <div className={cn("space-y-6", className)}>
      ...
      <div className="space-y-4">
        <button
          ...
          className="flex items-center justify-between w-full p-3 text-left rounded-lg bg-gray-50 hover:bg-gray-100 border border-gray-200 transition-all"
        >
