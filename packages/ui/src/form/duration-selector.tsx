  ...
  return (
    <div className={cn("space-y-2", className)}>
      ...
      <select
        id={selectorId}
        className={cn(
          "h-10 w-full rounded-md border border-0 bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
