        ...
        <div className="prose prose-gray max-w-none">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-medium text-gray-900 mb-2">
                  {t('sections.dataCollection.pollData.title')}
                </h3>
                <p className="text-gray-700">
                  {t('sections.dataCollection.pollData.description')}
                </p>
              </div>

              <div>
                <h3 className="text-lg font-medium text-gray-900 mb-2">
                  {t('sections.dataCollection.participantData.title')}
                </h3>
                <p className="text-gray-700">
                  {t('sections.dataCollection.participantData.description')}
                </p>
              </div>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-medium text-gray-900 mb-2">
                  {t('sections.dataProtection.encryption.title')}
                </h3>
                <p className="text-gray-700">
                  {t('sections.dataProtection.encryption.description')}
                </p>
              </div>

              <div>
                <h3 className="text-lg font-medium text-gray-900 mb-2">
                  {t('sections.dataProtection.zeroKnowledge.title')}
                </h3>
                <p className="text-gray-700">
                  {t('sections.dataProtection.zeroKnowledge.description')}
                </p>
              </div>
